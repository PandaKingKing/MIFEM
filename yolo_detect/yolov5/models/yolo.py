...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    no = na * (nc + 5)  # number of outputs = anchors * (classes + 5)  这里5表示4个坐标信息和1个conf
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from:-1, number:1, module:'Conv', args:[64,6,2,2]
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x}: #判断每一层属于什么结构
            c1, c2 = ch[f], args[0]
